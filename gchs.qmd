...
-   **University of the Cumberlands (2024 - 2027)**
...
-   **TaxBit**
    ...
    -   Data Science Consultant, 10/2023 - 04/2024

-   **USASOC AI Division**

    -   Data Scientist, 10/2023 - 04/2024

-   **TaxBit**

    -   Data Scientist, 04/20214 - 11/2025

-   **USSOCOM**
    -   Expert AI/ML Engineer, 11/2025 - Present
...
-   **2023**
    ...
    -   cryptotrackr [v1.1.0](https://github.com/TrevorFrench/cryptotrackr/tree/v1.1)
...
-   **2024**
    ...
    -   cryptotrackr [v1.2.0](https://doi.org/10.5281/zenodo.10775699) & [v1.3.0](https://github.com/TrevorFrench/cryptotrackr/releases/tag/v1.3.3)

    -   [In-Q-Tel Investment in Taxbit](https://www.washingtontechnology.com/companies/2024/05/taxbit-secures-investment-q-tel/396208/)

    -   Trained & Consulted IRS's Office of Digital Assets Initiative (ODAI)

-   **2025**

    -   [John Doe Summons](https://www.justice.gov/archives/opa/pr/court-authorizes-service-john-doe-summons-seeking-identities-us-taxpayers-who-have-used-1) Kraken

-  **2026**
    - Doing consulting work focused on digital asset intelligence
...
## Hawk Tuah {.smaller .scrollable}

-   Reached a valuation as high as ~$500 million
-   Quickly crashed, losing ~95% of its value
-   Insiders are alleged to have dumped their holdings
-   Promoters being sued for selling unregistered securities

![](./HAWK_USD.png){fig-align="center" height="400px"}

## What is Money? {.smaller .scrollable}
...
-   USD & the Gold Standard
    - U.S. currency used to be backed by precious metals
-   Commodity-backed currencies
    - Many currencies (including cryptocurrencies) are still backed by commodities such as Gold
